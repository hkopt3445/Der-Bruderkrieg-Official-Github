...
NGame = {
	...
	HANDS_OFF_START_TAG = "URG",	
	ALERT_SFX_COOLDOWN_DAYS = 14,				-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
},
...
NDiplomacy = {
	...
	VERY_GOOD_OPINION = 100,							-- Threshold for a country that has a very good opinion of you.
	VERY_BAD_OPINION = -100,							-- Threshold for a country that has a very bad opinion of you.
...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 10,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
